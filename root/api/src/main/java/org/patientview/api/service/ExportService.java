...
public interface ExportService{
     ...
     * @return A CSV file* @param resultCodes
     * @return
     * @throws ResourceNotFoundException
     * @throws FhirResourceException
     */
    @UserOnly
    HttpEntity<byte[]> downloadResults(Long userId, String fromDate, String toDate, List<String> resultCodes) throws ResourceNotFoundException, FhirResourceException;
     ...
     */
    @UserOnly
    HttpEntity<byte[]> downloadLetters(Long userId, String fromDate, String toDate) throws ResourceNotFoundException, FhirResourceException;
}
