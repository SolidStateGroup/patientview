...
import org.patientview.api.builder.TestObservationsBuilder;
...
public class ObservationServiceImpl extends AbstractServiceImpl<ObservationServiceImpl> implements ObservationService {
    ...
    public void addTestObservations(Long userId, Long groupId, FhirObservationRange fhirObservationRange)
        ...
        ResourceReference patientReference = Util.createFhirResourceReference(foundFhirLink.getResourceId());
        ...
        insertFhirDatabaseObservations(fhirDatabaseObservations);
    }
    ...
    private void insertFhirDatabaseObservations(List<FhirDatabaseObservation> fhirDatabaseObservations)
            throws FhirResourceException {
