...
INSERT INTO pv_group(id, Group_Name, Code, Sftp_User, Type_Id, Visible, Creation_Date,Created_By, Visible_To_Join) VALUES (5, 'GP_MEDICATION', 'Medicines From GP', null, 1, true, now(), 1, true);
